...
const FooterTop = () => {
  return (
    <div className ="grid grid-cols-2 lg:grid-cols-4 gap-8 border-b border-black/20">
       {data?.map((item,key)=>(
         <div key={key} className="flex items-center gap-3 hover:bg-gray-50 p-4 transition-colors cursor-pointer">
            {item?.icon}
             <div>
